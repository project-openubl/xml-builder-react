...
export interface FormStandardDocumentProps {
  onSubmit: (form: StandardDocumentFormData, input: any) => void;
}
...
export const FormStandardDocument: React.FC<FormStandardDocumentProps> = ({
        ...
        cells: [
          {
            title: (
              ...
              >
                ...
                >
                  <Controller
                    as={<SelectTipoIgv error={detalleError.tipoIgv} />}
  ...
  const onFormSubmit = (form: StandardDocumentFormData) => {
        ...
        <Grid md={6} lg={3} gutter="sm">
          <GridItem>
            ...
            >
              <Controller
                as={
                  <SelectTipoComprobanteBasico error={errors.tipoComprobante} />
                }
          ...
          <GridItem>
            {isNota && (
              ...
              >
                {isNotaCredito && (
                  <Controller
                    as={<SelectNotaCredito error={errors.tipoNota} />}
                    name="tipoNota"
                    control={control}
                  />
                )}
                {isNotaDebito && (
                  <Controller
                    as={<SelectNotaDebito error={errors.tipoNota} />}
                    name="tipoNota"
                    control={control}
                  />
                )}
